 ...
 */
class Acl_msg extends Admin_Controller
{
	function Acl_msg()
	{
		...
		$this->bep_site->set_crumb($this->lang->line('access_messeges'),'auth/admin/acl_msg');
	...
	{
		// Display Page
		$data['header'] = $this->lang->line('access_messeges');
		$data['page'] = $this->config->item('backendpro_template_admin') . "access_control/messeges";
		$data['module'] = 'auth';
