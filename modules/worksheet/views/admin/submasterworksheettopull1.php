<div id="submasterworksheetpull" style="width:210px;float:left;">Part of Sub-Master Worksheet<br/>
   	<?php
    	echo form_multiselect("submaster_id[]",$option_submasterworksheettopull,"","id='submasterworksheetpid', style='width:200px; height:150px; background-color:#CCCCCC'");
    ?>
	</div>
 ...
 <script type="text/javascript">
        ...
        $('#submasterworksheetpid :selected').each(function(i, selected) {
            submasterworksheetpid[i] = $(selected).val();
	    			...
	    			$.ajax({
							type: "POST",
							url : "<?php echo site_url('worksheet/admin/select_basicworksheettopull1')?>",
