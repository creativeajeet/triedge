...
<table width="1288">
  <tr>
    <td colspan="3"><h2 class="style2">Edit Sub-Master  Worksheet </h2></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td width="144"><select name="worksheet_type" style="width:140px; background-color:#CCCCCC">
	  ...
	  <option value="3" selected="selected">Sub-Master</option>
      <option value="4">Basic</option>
    </select></td>
    <td width="181">Master Worksheet Segment Type </td>
    <td width="167"><?php
  ...
  <tr>
    <td colspan="2">Part of Master Worksheet :: </td>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td colspan="9"><strong>
      <?php   foreach ($submasterworkdetails as $row){ echo $row->worksheet_name.anchor('worksheet/admin/deletepartmaster/'.$row->id."/".$id,'delete')."&nbsp"."&nbsp"; } ?>
    </strong></td>
  </tr>
  <tr>
