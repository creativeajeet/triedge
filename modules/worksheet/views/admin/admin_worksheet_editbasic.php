...
<table width="1288">
  ...
  <tr>
    ...
    <td width="144"><select name="worksheet_type" style="width:140px; background-color:#CCCCCC">
      ...
      <option value="4" selected="selected">Basic</option>
    </select></td>
  ...
  <tr>
    <td colspan="7">Part of Sub Master worksheet::</td>
    <td width="137">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="8"><strong>
      <?php   foreach ($basicworkdetails as $row){ echo $row->worksheet_name.anchor('worksheet/admin/deletepartsub/'.$row->id."/".$id,'delete')."&nbsp"."&nbsp"; } ?>
    </strong></td>
  </tr>
  <tr>
