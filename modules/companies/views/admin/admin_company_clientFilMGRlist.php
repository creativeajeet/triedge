...
<style>
	...
	*/
	...
	</style><h2>Client Managers - All</h2>

<?php if (count($results)){ 
 echo "<table>\n";
	echo "<thead>\n";
	 echo form_open('companies/admin/clientManagersFilte');
	echo "<tr>\n";
	...
	echo "<th></th>\n";
			echo "<th></th>\n";
		echo "<th>".form_dropdown('clients', array(''=>'')+$clients,'', "style='width:100px;  background-color:#CCCCCC'")."</th>\n";
		echo "<th></th>\n";
		echo "<th></th>\n";
		echo "<th>".form_dropdown('locations', array(''=>'')+$location,'', "style='width:100px;  background-color:#CCCCCC'")."</th>\n";
		echo "<th>".form_dropdown('consultants', array(''=>'')+$user,'', "style='width:100px;  background-color:#CCCCCC'")."</th>\n";
		echo "<th></th>\n";
		echo "<th></th>\n";
...
echo    "<td>".anchor_popup('candidates/admin/editCandidate/'.$row->id, img('http://software.triedge.in/assets/icons/pencil.png'), $atts)."</td>";
 ...
 echo    "<td>".form_dropdown('clientmgr',array('0'=>'')+$user,set_value('clientmgr',$row->manager),'stylestyle="width:100px; height:150px; background-color:#CCCCCC" disabled="disabled"')."</td>";
  echo    "<td>$row->pappdate</td>";
  echo    "<td>".form_dropdown('secclientmgr',array('0'=>'')+$user,set_value('secclientmgr',$row->sec_manager),'stylestyle="width:100px; height:150px; background-color:#CCCCCC" disabled="disabled"')."</td>";
