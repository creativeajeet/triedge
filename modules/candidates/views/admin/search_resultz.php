...
<table width="858">
  ...
  <tr>
    ...
    <td width="132">Current Company </td>
    <td width="164"><input type="text" name="currentcompany" id="currentcompany" /></td>
  </tr>
  <tr>
    <td height="24">Job Title </td>
    <td colspan="3"><input name="jobtitle" type="text" id="jobtitle" size="69" /></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td height="26" colspan="5">&nbsp;</td>
    <td><input name="submit" type="submit" class="btn btn-primary" id="submit2" value="Search" /></td>
  </tr>
</table>
</div>
...
<div  class="btn"><i class="icon-user"></i>                
  ...
  <?php print form_open_multipart('candidates/admin/foldera/');?>
    <div class="row-fluid">
					<div class="span12">
...
echo    "<td>".anchor_popup('candidates/admin/editCandidate/'.$row->id, img('http://localhost/upload/assets/icons/pencil.png'), $atts)."</td>";
...
$atts = array(
 ...
 $cv_image = "http://localhost/upload/assets/icons/document16.png";
 if(!$row->filepath)
 {
  echo "<td></td>";
   }
...
<table width="754">
  <tr>
    ...
    <td width="144"><select name="folder_name" style="background:#CCCCCC; width:143px;">
	<option value=""></option>
     <?php
 ...
 if (count($folder)){ 
    ...
    <td width="173"><input name="folder_name" id="folder_name" type="text" size="20" style="background:#CCCCCC"/></td>
