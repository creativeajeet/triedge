	...
	<script type="text/javascript">
	    ...
	    $(this).ready( function() {
    		$("#industry").autocomplete({
        		...
        		function(req, add){
          			$.ajax({
		        		url: "<?php echo base_url(); ?>index.php/candidates/admin/lookupindustry",
		          		dataType: 'json',
		          		type: 'POST',
		          		data: req,
		          		success:    
		...
		<script type="text/javascript">
	    $(this).ready( function() {
    		$("#indfunction").autocomplete({
      			minLength: 1,
      			source: 
        		function(req, add){
          			$.ajax({
		        		url: "<?php echo base_url(); ?>index.php/candidates/admin/lookupindfunc",
		          		dataType: 'json',
		          		type: 'POST',
		          		data: req,
		          		success:    
...
<div class="tabbable">
  <ul class="nav nav-tabs">
    <li class="active"><a href="#pane1" data-toggle="tab">Simple Search</a></li>
    <li><a href="#pane2" data-toggle="tab">Advanced Search</a></li>
   </ul>
...
<table width="858">
  ...
  <tr>
    ...
    <td>Entered By </td>
    <td><?php echo form_dropdown("enteredby",array('0' => '')+$users,"","id='id', style='width:170px;'");?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td> <button type="submit" class="btn btn-primary" class="btn btn-primary">Search</button></td>
  </tr>
</table>
<?php print form_close(); ?>
    </div>
