...
<table width="858">
  ...
  <tr>
    ...
    <td width="144"><input type="text" name="currentlocation" id="location" value="<?php echo  $currentlocation; ?>" /></td>
  ...
  <tr>
    ...
    <td><input type="text" name="currentcompany" id="provinsi_id" value="<?php echo $currentcompany; ?>" /></td>
    <td>Industry </td>
  ...
  <tr>
    ...
    <td><input name="jobtitle" type="text" id="jobtitle"  value="<?php echo $jobtitle; ?>"/></td>
    <td>Worksheet</td>
    <td><input type="text" name="worksheet" id="worksheet" value="<?php echo $worksheet; ?>"/></td>
    <td>Entered By </td>
    <td><?php echo form_dropdown("enteredby",array('0' => '')+$users, set_value('username', $enteredby));?></td>
  </tr>
  <tr>
