	...
	<script type="text/javascript">
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				// -- Clone table rows
				$(".cloneTableRows3").live('click', function(){
	...
	<table width="774" id="table6">
      ...
      <tr height="20">
        ...
        <td width="139"><div align="center">
          <input name="degree" type="text" size="15" id="sheetname2" value="<?php echo $folder_name; ?>"/>
        </div></td>
...
<table width="1237">
 ...
 <?php print form_close(); ?>  
    ...
    <h2></h2>  
  <?php print form_open('candidates/admin/sharefolder/');?> 
	<table width="774" id="table3">
      

      <tr height="20">
        <td width="76" style="padding-top:5px;">Sheet Name </td>
        <td width="121" style="padding-top:5px;"><?php echo form_dropdown("folder_name",$sharefolder,set_value('folder_name',$folder_name),"id='id', style='width:250px; background-color:#CCCCCC'");?></td>
        <td width="148"><div align="center">Share With </div></td>
        <td width="132"><?php echo form_dropdown("userid",$user,"","id='id', style='width:250px; background-color:#CCCCCC'");?></td>
        <td width="59"><span style="padding-top:5px;">
          <input type="submit" class="btn btn-primary" name="sharefolder" value="Share" />
        </span></td>
        <td width="80">&nbsp;</td>
        <td width="38">&nbsp;</td>
        <td width="84"></td>
	 ...
	 <?php print form_close(); ?> 
	  <h2>Add more in this Mapping Sheet</h2>

<?php print form_open_multipart('candidates/admin/newmapping/');?>
Input Name : <input name="sheetname" type="text" size="15" id="sheetname" value="<?php echo $folder_name; ?>"/>
<table width="1076" id="table10">
      <tr bgcolor="#000033">
        <th width="30" bgcolor="#000000"><div align="center"><img src="http://software.triedge.in/assets/icons/add.png" class="cloneTableRows3" /></div></th>
        <th width="88" height="3" bgcolor="#000000"><div align="center" class="style1">Name</div></th>
        <th bgcolor="#000000"><div align="center" class="style1">Current Comp. </div></th>
        <th bgcolor="#000000"><div align="center" class="style1">Jobtitle</div></th>
        <th width="208" bgcolor="#000000"><div align="center" class="style1">
...
<?php echo form_open('candidates/admin/'.$page); ?>
