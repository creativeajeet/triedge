...
echo "<tr valign='top'>\n";
  echo    "<td><input class='case' name='c_id[]' value='".$row->canid."' type='checkbox'></td>";
  $atts = array(
              'width'      => '700',
              'height'     => '560',
              'scrollbars' => 'yes',
...
echo    "<td>".anchor_popup('candidates/admin/editCandidate/'.$row->canid, img('http://software.triedge.in/assets/icons/pencil.png'), $atts)."</td>";
