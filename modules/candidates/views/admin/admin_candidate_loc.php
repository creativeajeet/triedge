...
<h2></h2>
<h2>All Locations </h2>
<div align="right"><div align="right"><span id="updated">Location Updated :: <?php echo $totalupdated; ?></span><div align="right" style="margin-right:170px; margin-top:-17px;"><span id="notupdated">Total DB. :: <?php echo $total; ?></span></div></div></div>
<div align="left" style="margin-top:-15px;"><div align="left"><?php echo anchor('synonym/admin/allupdatedloc', '<span id="updated">All Updated Location List</span>'); ?><div align="left" style="margin-left:150px; margin-top:-18px;"><?php echo anchor('synonym/admin/notupdatedlocgroup', '<span id="notupdated">Not Updated Location Group List</span>'); ?></div><div align="left" style="margin-left:360px; margin-top:-18px;"><?php echo anchor('synonym/admin/locationup', '<span>All Location List</span>'); ?></div><div align="left" style="margin-left:420px; margin-top:-18px;"></div></div></div>
<br/>
