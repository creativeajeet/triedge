...
<ul>
		...
		<li><a href="#tabs-3">Open Folder</a></li>
		<li><a href="#tabs-4">Open Worksheet</a></li>
  </ul>
...
<input name="worksheet" type="hidden" value="<?php echo $openedworksheet; ?>"/>
<table width="100%">
  <tr>
...
//echo form_open('candidates/admin/excel/'.$page); 
 echo form_open('candidates/admin/foldera/'.$page);
?>
...
echo    "<td>".anchor_popup('candidates/admin/countcompanywise/'.$openedworksheet, 'Companywise Counts', $atts1)."</td>";
?>
</div>
<br/>
<div class="row-fluid">
...
$atts = array(
 ...
 <?php echo $links; ?><div align="right"><div id="excel" align="right" style="margin-right:80px;>"><input type="submit" class="btn btn-primary" name="worksheet_excel" value="Generate Excel" /></div><div id="delete" align="right" style="margin-bottom:40px; margin-top:-20px;"><input type="submit" class="btn btn-primary" name="delete" value="Delete" /></div></div>
...
<table width="754">
  <tr>
    ...
    <td width="160"><input type="submit" class="btn btn-primary" name="add" value="Add" id="submit" />   </td>
    <td width="160"><input type="submit" class="btn btn-primary" name="move" value="Move" id="move" /></td>
  </tr>
</table>
