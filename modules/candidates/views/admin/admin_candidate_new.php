...
<?php print form_open_multipart('candidates/admin/newCandidate/'.$id);?>
<table width="641">
    <tr>
      <td height="27">Cand. Mgmt. </td>
      <td height="27"><?php echo form_dropdown('cand_mgmt', array('0'=>'')+$candmgmt,'',"style='width:120px; background-color:#CCCCCC'"); ?></td>
      <td width="94">Introduced By </td>
      <td width="122"><?php echo form_dropdown('entered_by', $usernames, set_value('entered_by', $this->session->userdata('username')),"style='width:120px; background-color:#CCCCCC'"); ?></td>
      <td width="90">Input By </td>
    ...
    <tr>
      ...
      <td><input name="current_company" id="companyid" type="text" size="20" style="background:#CCCCCC" /></td>
      <td>Job Title </td>
    ...
    <tr>
      ...
      <td>Grade</td>
      <td><div id="gradelist">
            <input name="grade" id="grade" type="text" size="20" style="background:#CCCCCC" />
        </div>
		<script type="text/javascript">
   ...
   <script type="text/javascript">
      ...
      <td colspan="2">Add to my Worksheet </td>
      <td><div align="right">
        <?php  $atts = array(
              'width'      => '1010',
              'height'     => '240',
   ...
   <script type="text/javascript">
      ...
      <td colspan="3" rowspan="2"><?php echo form_multiselect("myworksheet[]",array('0'=>'')+$worksheet,"","id='id', style='width:140px; height:30px; background-color:#CCCCCC'");?></td>
    </tr>
	 <tr>
       <td>Folder</td>
