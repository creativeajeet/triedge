...
Input Name : <input name="sheetname" type="text" size="15" id="sheetname" value="<?php echo $sheetname; ?>"/>
<table width="1076" id="table4">
	...
	<table width="774" id="table3">
      ...
      <tr height="20">
        <td width="139" style="padding-top:5px;"><input type="submit" class="btn btn-primary" name="save" value="Export Excel" /></td>
        <td width="66"><div align="right">Save As </div></td>
        <td width="106"><div align="center">
          <input name="degree" type="text" size="15" id="sheetname2" value="<?php echo $sheetname; ?>"/>
        </div></td>
        <td width="107"><span style="padding-top:5px;">
          <input type="submit" class="btn btn-primary" name="save" value="Go" />
        </span></td>
        <td width="133">&nbsp;</td>
        <td width="138">&nbsp;</td>
        <td width="53"></td>
