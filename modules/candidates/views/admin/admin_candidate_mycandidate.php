...
<?php print form_open('candidates/admin/search/');?>
  ...
  <tr>
    ...
    <td width="350"><select name="heading" id="heading" disabled="disabled">
    ...
    <td colspan="2"><input name="keyword" type="text" id="keyword" size="60" disabled="disabled"/></td>
    <td width="68"><div align="right">
      <input name="submit22" type="submit" class="btn btn-primary" id="submit22" value="Search" disabled="disabled"/>
    </div></td>
  </tr>
   <tr>
    <td colspan="6">&nbsp;</td>
  ...
  <tr>
   ...
   <tr>
     <td colspan="26"><div align="right">
      <input name="alphain" type="submit" class="btn btn-primary" id="submit2" value="Search" disabled="disabled" />
    </div></td>
     </tr>
</table>
<?php echo form_close(); ?>
...
<table width="858">
  ...
  <tr>
    ...
    <td>Entered By </td>
    <td><?php echo form_dropdown("enteredby",array('0' => '')+$users,set_value('enteredby',$username),'disabled="disabled"');?></td>
  </tr>
  <tr>
