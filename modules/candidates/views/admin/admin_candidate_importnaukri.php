...
<body>
<?php echo form_open_multipart('candidates/admin/do_uploadNaukri');?>
<table width="772" border="1">
  
<tr>
    <td height="31" colspan="5"><img src="<?php echo base_url(); ?>assets/images/naukri.gif"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<table width="812" border="1">
  ...
  <tr>
    ...
    <td width="769" colspan="4">Name of the Candidate</td>
  </tr>
  <tr>
    <td height="23">B.</td>
  ...
  <tr>
    <td height="23">H.</td>
    <td colspan="4">Current Employer </td>
  </tr>
  <tr>
    <td height="23">I.</td>
    <td colspan="4">Current Designation </td>
  </tr>
  <tr>
    <td height="23">J.</td>
    <td colspan="4">Annual Salary</td>
  </tr>
  <tr>
    <td height="23">K.</td>
    <td colspan="4">P. G. Course </td>
  </tr>
  <tr>
    <td height="23">&nbsp;</td>
    <td colspan="4">&nbsp;</td>
