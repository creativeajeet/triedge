...
<?php $pageno = ($this->uri->segment(6))? $this->uri->segment(6) : 0; ?>
<div align="left"><?php echo anchor('candidates/admin/'.$page.'/'.$openedworksheet.'/'.$pageno, '<span id="updated">Go Back</span>'); ?></div>
