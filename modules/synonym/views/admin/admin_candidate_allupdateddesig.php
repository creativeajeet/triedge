...
<div align="right"><div align="right"><span id="updated">Updated Designation :: <?php echo $total; ?></span><div align="right" style="margin-right:180px; margin-top:-17px;"><span id="notupdated">Total DB :: <?php echo $totaldb; ?></span></div></div></div>
<div align="left" style="margin-top:-15px;"><div align="left"><?php echo anchor('synonym/admin/allupdateddesig', '<span id="updated">All Updated Designation List</span>'); ?><div align="left" style="margin-left:150px; margin-top:-18px;"><?php echo anchor('synonym/admin/notupdateddesig', '<span id="notupdated">Not Updated Designaiton List</span>'); ?></div><div align="left" style="margin-left:310px; margin-top:-18px;"><?php echo anchor('synonym/admin/designationup', '<span>All Designation List</span>'); ?></div><div align="left" style="margin-left:420px; margin-top:-18px;"></div></div></div>
<br/>
