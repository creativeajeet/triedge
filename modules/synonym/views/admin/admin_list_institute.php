...
<p align="right"><?php echo anchor('synonym/admin/cleanedDesigList','Institute - Cleaned Synonym Group List'); ?> </p>
</div>
</div>
<?php echo form_close(); ?>	
<h2>Institute - Pending Synonym Group List</h2>
<div align="right"><div align="right"><span id="updated"><?php echo anchor('synonym/admin/listview', '<span id="updated">Candidatewise View</span>'); ?> </span><div align="right" style="margin-right:150px; margin-top:-17px;"><span id="notupdated">Institute - Pending Synonym Group :: <?php echo $total; ?></span></div></div></div>
<div align="left" style="margin-top:-15px;"><div align="left"><div align="left" style="margin-top:-18px;"><?php echo anchor('synonym/admin/senttosynonymloc', '<span>Institute - Cleaned Synonym List</span>'); ?></div><div align="left" style="margin-left:250px; margin-top:-18px;"><?php echo anchor('synonym/admin/noncore', '<span>Non-Core</span>'); ?></div></div></div>	
		<div class="row-fluid">
					<div class="span12">
...
echo form_open('synonym/admin/filtercomp/'.$page);
 ...
 echo "<th>".anchor('synonym/admin/index/','<span>All</span>',array('id'=>'all'))."</th>\n";
	...
	echo "</tr>\n";
		echo form_close();
 echo form_open('synonym/admin/sendtoinstt/'.$page);
 	echo "<thead>\n";
	echo "<tr>\n";
	echo "<th><div align='left'><input id='selectall' type='checkbox'></div></th>\n";
			echo "<th><div align='left'>Institute</div></th>\n";
...
echo "<tr valign='top'>\n";
  ...
  echo    "<td>".anchor_popup('candidates/admin/synonymcand/'.$row->institute,$row->countCourse,$atts)."</td>";
