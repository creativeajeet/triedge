...
<div align="right"><div align="right"><span id="updated">Not Updated Courses :: <?php echo $total; ?></span><div align="right" style="margin-right:180px; margin-top:-17px;"><span id="notupdated">Total DB :: <?php echo $totaldb; ?></span></div></div></div>
<div align="left" style="margin-top:-15px;"><div align="left"><?php echo anchor('synonym/admin/allupdatedcourse', '<span id="updated">All Updated Courses List</span>'); ?><div align="left" style="margin-left:150px; margin-top:-18px;"><?php echo anchor('synonym/admin/notupdatedcoursegroup', '<span id="notupdated">Not Updated Course Group List</span>'); ?></div><div align="left" style="margin-left:360px; margin-top:-18px;"><?php echo anchor('synonym/admin/courseup', '<span>All Courses List</span>'); ?></div><div align="left" style="margin-left:420px; margin-top:-18px;"></div></div></div>
...
<div align="right"> <?php 
    ...
    echo anchor('synonym/admin/editcourse/'.$page,'Edit Mode'); ?></div>

<?php echo form_open('synonym/admin/updatecourse/'.$category.'/'.$page); ?><div class="row-fluid">
					<div class="span12">
...
echo "<tr valign='top'>\n";
 ...
 echo    "<td><input class='case' name='cand_id[]' value='".$row->id."' type='hidden'><input type='text' name='companyname[]' size=100 value='".$row->course."' /></td>";
