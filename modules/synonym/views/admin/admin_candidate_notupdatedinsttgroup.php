...
<div align="right"><div align="right"><span id="updated">Not Updated Instt Groups :: <?php echo $total; ?></span><div align="right" style="margin-right:180px; margin-top:-17px;"><span id="notupdated">Total DB :: <?php echo $totaldb; ?></span></div></div></div>
<div align="left" style="margin-top:-15px;"><div align="left"><?php echo anchor('synonym/admin/allupdatedinstt', '<span id="updated">All Updated Institutes List</span>'); ?><div align="left" style="margin-left:150px; margin-top:-18px;"><?php echo anchor('synonym/admin/notupdatedinstt', '<span id="notupdated">Not Updated CandWise Institutes List</span>'); ?></div><div align="left" style="margin-left:400px; margin-top:-18px;"><?php echo anchor('synonym/admin/instituteup', '<span>All Institutes List</span>'); ?></div><div align="left" style="margin-left:420px; margin-top:-18px;"></div></div></div>
<br/>
<?php $page = $this->uri->segment(4); ?>
<?php $category = $this->uri->segment(3); ?>
<?php echo form_open('synonym/admin/updateinsttgroup/'.$category.'/'.$page); ?><div class="row-fluid">
					<div class="span12">
...
echo "<tr valign='top'>\n";
 echo    "<td><input class='case' name='c_id[]' value='".$row->institute."' type='checkbox'></td>";

 echo    "<td><input class='case' name='cand_id[]' value='".$row->institute."' type='hidden'><input type='text' name='companyname[]' size=100 value='".$row->institute."' /></td>";
 echo    "<td>".anchor_popup('candidates/admin/synonymcand/'.$row->institute,$row->countloc,$atts)."</td>";
