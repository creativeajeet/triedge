...
<h2></h2>
<h2>Designaitons to be updated</h2>
<div align="right"><div align="right"><span id="updated">Not Updated Designation :: <?php echo $total; ?></span><div align="right" style="margin-right:180px; margin-top:-17px;"><span id="notupdated">Total DB :: <?php echo $totaldb; ?></span></div></div></div>
<div align="left" style="margin-top:-15px;"><div align="left"><?php echo anchor('synonym/admin/allupdateddesig', '<span id="updated">All Updated Designation List</span>'); ?><div align="left" style="margin-left:180px; margin-top:-18px;"><?php echo anchor('synonym/admin/notupdateddesiggroup', '<span id="notupdated">Not Updated Designation Group List</span>'); ?></div><div align="left" style="margin-left:400px; margin-top:-18px;"><?php echo anchor('synonym/admin/designationup', '<span>All Designation List</span>'); ?></div><div align="left" style="margin-left:420px; margin-top:-18px;"></div></div></div>
...
<div align="right"> <?php 
    ...
    echo anchor('synonym/admin/editdesig/'.$page,'Edit Mode'); ?></div>

<?php echo form_open('synonym/admin/updatedesig/'.$category.'/'.$page); ?><div class="row-fluid">
					<div class="span12">
...
echo "<tr valign='top'>\n";
 ...
 echo    "<td><input class='case' name='cand_id[]' value='".$row->id."' type='hidden'><input type='text' name='companyname[]' size=100 value='".$row->designation."' /></td>";
