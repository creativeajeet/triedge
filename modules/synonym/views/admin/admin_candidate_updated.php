...
<div align="right"><div align="right"><span id="updated">Company Updated :: <?php echo $totalupdated; ?></span><div align="right" style="margin-right:170px; margin-top:-17px;"><span id="notupdated">Total DB. :: <?php echo $totaldb; ?></span></div></div></div>
...
<?php if (count($results)){ 
 echo "<table>\n";
	...
	echo "<th><div align='left'><input id='selectall' type='checkbox'></div></th>\n";
		...
		echo "<th><div align='left'>Non-Core<input id='selectalll' type='checkbox'>All</div></th>\n";
		echo "<th>Status</th>\n";
			echo "</tr>\n</thead>\n<tbody>\n";
