...
<h2></h2>
<h2>Designation Groups to be updated</h2>
<div align="right"><div align="right"><span id="updated">Not Updated Designation Groups :: <?php echo $total; ?></span><div align="right" style="margin-right:240px; margin-top:-17px;"><span id="notupdated">Total DB :: <?php echo $totaldb; ?></span></div></div></div>
<div align="left" style="margin-top:-15px;"><div align="left"><?php echo anchor('synonym/admin/allupdateddesig', '<span id="updated">All Updated Designation List</span>'); ?><div align="left" style="margin-left:180px; margin-top:-18px;"><?php echo anchor('synonym/admin/notupdateddesig', '<span id="notupdated">Not Updated CandWise Designation List</span>'); ?></div><div align="left" style="margin-left:420px; margin-top:-18px;"><?php echo anchor('synonym/admin/designationup', '<span>All Designation List</span>'); ?></div><div align="left" style="margin-left:420px; margin-top:-18px;"></div></div></div>
<br/>
<?php $page = $this->uri->segment(4); ?>
<?php $category = $this->uri->segment(3); ?>
<?php echo form_open('synonym/admin/updatedesiggroup/'.$category.'/'.$page); ?><div class="row-fluid">
					<div class="span12">
...
<?php if (count($results)){ 
 echo "<table>\n";
	...
	echo "<th>Current Llocation</th>\n";
		echo "<th>No. of Cands</th>\n";
...
echo "<tr valign='top'>\n";
 echo    "<td><input class='case' name='c_id[]' value='".$row->designation."' type='checkbox'></td>";

 echo    "<td><input class='case' name='cand_id[]' value='".$row->designation."' type='hidden'><input type='text' name='companyname[]' size=100 value='".$row->designation."' /></td>";
 echo    "<td>".anchor_popup('candidates/admin/synonymcand/'.$row->designation,$row->countloc,$atts)."</td>";
  
 if(($row->is_desig_updated)==1)
   {
