...
<?php echo form_close(); ?>	
<h2></h2>
<h2>All Company names </h2>
<div align="right"><div align="right"><span id="updated">Company Updated :: <?php echo $totalupdated; ?></span><div align="right" style="margin-right:170px; margin-top:-17px;"><span id="notupdated">Total DB. :: <?php echo $total; ?></span></div></div></div>
...
echo "<tr valign='top'>\n";
 ...
 echo    "<td><input class='case' name='cand_id[]' value='".$row->id."' type='hidden'><input type='text' name='companyname[]' size=100 value='".$row->company."' /></td>";
