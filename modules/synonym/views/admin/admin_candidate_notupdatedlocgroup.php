...
<h2></h2>
<h2>Locations to be updated</h2>
<div align="right"><div align="right"><span id="updated">Not Updated Location Groups :: <?php echo $total; ?></span><div align="right" style="margin-right:220px; margin-top:-17px;"><span id="notupdated">Total DB :: <?php echo $totaldb; ?></span></div></div></div>
<div align="left" style="margin-top:-15px;"><div align="left"><?php echo anchor('synonym/admin/allupdatedloc', '<span id="updated">All Updated Location List</span>'); ?><div align="left" style="margin-left:150px; margin-top:-18px;"><?php echo anchor('synonym/admin/notupdatedloc', '<span id="notupdated">Not Updated CandWiseLocation List</span>'); ?></div><div align="left" style="margin-left:360px; margin-top:-18px;"><?php echo anchor('synonym/admin/locationup', '<span>All Location List</span>'); ?></div><div align="left" style="margin-left:420px; margin-top:-18px;"></div></div></div>
<br/>
<?php $page = $this->uri->segment(4); ?>
<?php $category = $this->uri->segment(3); ?>
<?php echo form_open('synonym/admin/updatelocgroup/'.$category.'/'.$page); ?><div class="row-fluid">
					<div class="span12">
...
echo "<tr valign='top'>\n";
 echo    "<td><input class='case' name='c_id[]' value='".$row->current_location."' type='checkbox'></td>";

 echo    "<td><input class='case' name='cand_id[]' value='".$row->current_location."' type='hidden'><input type='text' name='companyname[]' size=100 value='".$row->current_location."' /></td>";
 echo    "<td>".anchor_popup('candidates/admin/synonymcand/'.$row->current_location,$row->countloc,$atts)."</td>";
  
 if(($row->is_loc_updated)==1)
   {
