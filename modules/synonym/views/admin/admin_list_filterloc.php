...
echo form_open('synonym/admin/filtercomp/'.$page);
 ...
 echo "<th>".anchor('synonym/admin/index/','<span>All</span>',array('id'=>'all'))."</th>\n";
	echo "<th><input type='text' name='locf' size='50' value='".$loc."'/><input type='submit' name='Submit' value='Filter' /></th>\n";
	echo "</tr>\n";
		echo form_close();
 echo form_open('synonym/admin/sendtoparent/'.$page);
	...
	echo "<th><div align='left'><input id='selectall' type='checkbox'></div></th>\n";
			echo "<th><div align='left'>Location Name</div></th>\n";
...
echo "<tr valign='top'>\n";
  ...
  echo    "<td><input class='case' name='synonym[]' value='".$row->current_location."' type='checkbox'></td>";
