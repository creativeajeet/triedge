...
<?php echo form_close(); ?>	
<h2>Candidatewise View</h2>
<div align="right"><div align="right"><span id="updated"><?php echo anchor('synonym/admin/', '<span id="updated">CompanyGroupwise View</span>'); ?> </span><div align="right" style="margin-right:150px; margin-top:-17px;"><span id="notupdated">Pending names to be Sent to synonym :: <?php echo $total; ?></span></div></div></div>
