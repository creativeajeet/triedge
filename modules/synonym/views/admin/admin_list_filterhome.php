...
<?php echo form_close(); ?>			<div class="row-fluid">
					<div class="span12">
...
echo form_open('synonym/admin/filtercomp/'.$page);
 ...
 echo "<th>".anchor('synonym/admin/index/','<span>All</span>',array('id'=>'all'))."</th>\n";
	echo "<th><input type='text' name='compf' size='50' value='".$comp."'/><input type='submit' name='Submit' value='Filter' /></th>\n";
	echo "</tr>\n";
		echo form_close();
...
echo "<tr valign='top'>\n";
  ...
  echo    "<td><input class='case' name='synonym[]' value='".$row->company."' type='checkbox'></td>";
