...
<div align="right"><div align="right"><span id="updated">Not Updated Locations :: <?php echo $total; ?></span><div align="right" style="margin-right:180px; margin-top:-17px;"><span id="notupdated">Total DB :: <?php echo $totaldb; ?></span></div></div></div>
...
<div align="right"> <?php 
    ...
    echo anchor('synonym/admin/editloc/'.$page,'Edit Mode'); ?></div>
<?php echo form_open('synonym/admin/updateloc/'.$category.'/'.$page); ?><div class="row-fluid">
					<div class="span12">
...
echo "<tr valign='top'>\n";
 ...
 echo    "<td><input class='case' name='cand_id[]' value='".$row->id."' type='hidden'><input type='text' name='companyname[]' size=100 value='".$row->current_location."' /></td>";
