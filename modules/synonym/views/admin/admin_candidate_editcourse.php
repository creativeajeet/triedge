...
<table width="100%">
  <tr>
    <th scope="col"><div align="center"><a href="http://software.triedge.in/index.php/admin">Dashboard</a></div></th>
    <th scope="col"><div align="center"><a href="http://software.triedge.in/index.php/candidates/admin/admin">Candidates</a></div></th>
    <th scope="col"><div align="center"><a href="http://software.triedge.in/index.php/companies/admin/admin">Company</a></div></th>
    <th scope="col"><div align="center"><a href="http://software.triedge.in/index.php/pof/admin/admin">Position List</a></div></th>
    <th scope="col"><div align="center"><a href="http://software.triedge.in/index.php/pof/admin/createVRS">MIS</a></div></th>
    <th scope="col"><div align="center"><a href="http://software.triedge.in/index.php/metrices/admin/admin">Tools</a></div></th>
  </tr>
</table>
<h2>Candidates Info in Edit Mode</h2>
<?php $page = $this->uri->segment(4); ?>
<?php $pageno = ($this->uri->segment(5))? $this->uri->segment(5) : 0; ?>
<div align="left"><?php echo anchor('synonym/admin/notupdatedcourse/'.$page, '<span id="updated">Go Back</span>'); ?></div>
<div align="right"><?php echo anchor('synonym/admin/allupdated', '<span id="updated">Updated Company List in View Mode</span>'); ?></div>

<?php echo form_open('synonym/admin/dupRemover/'.$pageno); ?>
...
<?php
 ...
 echo "<table width='95%' cellspacing='1' cellpadding='0' align='center' border='1' id='cTable'>\n";
	...
	echo "<td width='2%' class='heading'><div align='center'>Del</div></td>\n";
		...
		echo "<td width='7%' class='heading'>Company.</td>\n";
 ...
 if(!$row->file_to_view)
 {
  ...
  echo    "<td><div align='center'>".anchor_popup('candidates/admin/viewcv/'.$row->id, img($cv_image), $atts)."</div></td>";
   ...
   echo    "<td><input type='text' name='telephone[]' value='$row->telephone' size='12'/></td>";
    echo    "<td><input type='text' name='current_company[]' id='current_company' value='$row->company' size='20'/></td>";
...
echo    "<td><textarea name='comment[]'>$row->comment</textarea></td>";
 ...
 <h2></h2>
 <?php echo $links; ?><div align="left" style="position:relative">Jump to page no.<input type="text" name="jump" size="6" /><input type="submit" class="btn btn-primary" name="go" value="GO" /></div><div align="right" style="position:relative; margin-top:-10px; margin-bottom:20px;"><input type="submit" class="btn btn-primary" name="save" value="Save" /></div>
