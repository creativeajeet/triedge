<div id="parentname" style="width:260px;float:left;">Parent Name<br/>
   	<?php
    	echo form_multiselect("parentid[]",$option_segment,'',"id='parentnameid', style='width:250px; height:150px; background-color:#CCCCCC'","id='id'");
    ?>
</div>
 <div id="currentchild">Child Name<br/>
   	<?php
