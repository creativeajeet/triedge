...
<b>Allocated To </b>- <?php echo $detail['consuls']; ?> | <b>Client Manager</b> - <?php echo $detail['username']; ?> | <b>Tags</b> - <?php foreach($tags as $key=>$row)
echo $row->tag_name.",";
?><br/>
...
<p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds and Total records found :: <b><?php echo $master; ?></b></p>
 ...
 <?php echo $links; ?>
	...
	<div><table width="978">
  <tr>
    <td width="154" height="26">Send to Folder</td>
    <td width="198"><select name="folder_name" id="folder_name" style="background:#CCCCCC; width:143px;">
	<option value=""></option>
     <?php
    ...
    <td width="107">or New Folder </td>
    <td width="250"><input name="newfolder" id="newfolder" type="text" size="20" style="background:#CCCCCC"/></td>
    <td width="245"><input type="submit" class="btn btn-primary" value="Go" id="submit" />    </td>
  </tr>
</table>
<table width="977">
  <tr>
    <td width="153" height="26">Send To Position</td>
    <td width="564"><?php echo form_dropdown("pofid",$positions,"","id='id', style='width:450px; background-color:#CCCCCC'");?> </td>
    <td width="244"><input type="submit" class="btn btn-primary" value="Go" id="submit" name="position" />
   </td>
  </tr>
</table>
<table width="974">
  <tr>
    <td width="152" height="26">Refer To </td>
    <td width="566"><?php echo form_dropdown("userid",$users,"","id='id', style='width:250px; background-color:#CCCCCC'");?> </td>
    <td width="240"><input type="submit" class="btn btn-primary" value="Go" id="submit" />
   </td>
  </tr>
</table>
<table width="976">
  <tr>
    <td width="155" height="26">Send to My Worksheet </td>
    <td width="562"><?php echo form_dropdown("myworksheet",array('0'=>'')+$mworksheet,"","id='id', style='width:250px; background-color:#CCCCCC'");?></td>
    <td width="243"><input type="submit" class="btn btn-primary" name="add" value="Go" id="submit" />
   </td>
  </tr>
</table>
...
<table width="1237">
  ...
  <tr>
    <td colspan="2"><div id="country" style="width:180px;float:left;">Segment Type<br/>
           <?php
  ...
  <tr>
	...
	<table width="1000" id="table2">
      ...
      <tr height="20">
        ...
        <td><div align="center">
          <input name="no_of_pos" type="text" size="5" value="<?php echo $detail['no_of_pos']; ?>"/>
        </div></td>
        <td><div align="center">
          <input name="grade" type="text" size="5" value="<?php echo $detail['grade']; ?>"/>
        </div></td>
        <td><div align="center">
          <input name="designation" type="text" size="15" value="<?php echo $detail['designation']; ?>"/>
        </div></td>
        <td> <div align="center">
          <select name="level">
		  <option value=""></option>
        ...
        <td><div align="center">
          <input name="sal_f" type="text" size="2" value="<?php echo $detail['sal_f']; ?>"/>
        </div></td>
        <td><div align="center">
          <input name="sal_t" type="text" size="2" value="<?php echo $detail['sal_t']; ?>"/>
        </div></td>
        <td><div align="center">
