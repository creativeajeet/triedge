...
<?php echo form_close(); ?>
<div align="right"><?php echo anchor('usage/admin/posDeliveryDaily/', 'All Allocated'); ?> | <?php echo anchor('usage/admin/posDeliveryActive/', 'Active Positions'); ?></div>
<?php 
$date = date('Y-m-d');
...
echo  "<th><div align='center'>Response Status</div</th>\n";
