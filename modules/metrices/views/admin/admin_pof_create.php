...
<?php 
   foreach($admin as $row)
    {
	 echo "<input name='jobtitle' type='text' size='25' value='$row->id'/>";
	}
	?>
<table width="1237">
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo form_dropdown('client_id', array('0' => '')+$clients, '', "style='width:250px;  background-color:#CCCCCC'"); ?></td>
  ...
  <tr>
	...
	<table width="1000" id="table2">
      ...
      <tr height="20">
        ...
        <td><div align="center">
          <input name="no_of_pos" type="text" size="5"/>
        </div></td>
        <td><div align="center">
        ...
        <td> <div align="center">
		  ...
		  <option value=""></option>
            ...
            <option value="senior_mid">Senior Mid</option>
        ...
        <td><div align="center">
          <input name="sal_f" type="text" size="2"/>
        </div></td>
        <td><div align="center">
          <input name="sal_t" type="text" size="2"/>
        </div></td>
        <td><div align="center">
...
<table width="847">
  <tr>
    ...
    <td width="151"scope="col">Positon Given By(client side) </td>
    <td width="135" scope="col"><input name="pos_given_by" type="text" size="15" /></td>
    <td width="151" scope="col">Postition Taken On </td>
    <td width="139" scope="col"><input name="pos_taken_on" type="text" size="15" class="input-medium datepick" /></td>
  </tr>
  <tr>
    ...
    <td><?php echo form_dropdown("client_mgr",array('0' => '')+$user,"","id='id', style='width:110px; background-color:#CCCCCC'");?></td>
  </tr>
  <tr>
    <td>Entered By </td>
  ...
  <tr>
    <td height="38" colspan="6"><table width="831" id="table4">
      <tr bgcolor="#000033">
      ...
      <tr height="20">
        <td style="padding-top:5px;"><div align="center">
          <input name="h_name[]" type="text" size="15" />
        </div></td>
        <td width="127"><div align="center">
          <input name="h_designation[]" type="text" size="15" />
        </div></td>
        <td width="139"><div align="center">
            <input name="h_telephone[]" type="text" size="15" />
        </div></td>
        <td><div align="center">
            <input name="h_mobile[]" type="text" size="15" />
        </div></td>
        <td><div align="center">
            <input name="h_email[]" type="text" size="35" />
        </div></td>
        <td></td>
      </tr>
    </table></td>
