		...
		<?php $month = date('n');
		  if($month>=1 && $month<=3)
		   ...
		   elseif($month>=4 && $month<=6)
			...
			?>
<?php echo form_open('metrices/admin/enteroldleave'); ?>
...
<?php if (count($users)){ 
 echo "<table>\n";
	...
	echo "<tr>\n";
	echo "<th>Name</th>\n";
	echo "<th><div align='center'>No. of Leaves</div></th>\n";
	echo "</tr>\n</thead>\n<tbody>\n";
 ...
 echo    "<td><div align='center'><input name='leavetaken[]' type='text' size='6' /></div></td>";
  echo  "</tr>";
 }
 echo "</tbody>\n</table>";
 }
