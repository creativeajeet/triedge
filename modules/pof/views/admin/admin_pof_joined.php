...
<h2>Joined</h2> 
<div align="right">
  <div style="margin-right:20px">Total Joined::</div>
  <div style="color:#FF0000; margin-top:-18px; font-size:14px"><b><?php echo $total; ?></b></div></div>
  
  <div align="left" style="margin-top:-15px;"><div align="left"><?php echo anchor('pof/admin/getCandFinalRound', '<span id="updated">Candidates at Final Round Stage</span>'); ?><div align="left" style="margin-left:210px; margin-top:-18px;"><?php echo anchor('pof/admin/getCandOffer', '<span id="notupdated">Offer Stage</span>'); ?></div><div align="left" style="margin-left:310px; margin-top:-18px;"><?php echo anchor('pof/admin/CandClosed', '<span>Closed</span>'); ?></div></div></div>
<div id="show">
<?php
 if (count($results)){ 
 echo "<table id='data'>\n";
