...
<?php
 ...
 echo "<table>\n";
  echo form_open('pof/admin/filterposdel/');
	...
	echo "<th></th>\n";
	echo "<th></th>\n";
	echo "<th>".form_dropdown('companyfilterpos',array('a'=>'')+$companyF,set_value('companyfilterpos',$company),"style='width:135px;'")."</th>\n";
	  echo "<th></th>\n";
	   echo "<th></th>\n";
		echo "<th>".form_dropdown('consul',array('a'=>'')+$consulF,set_value('consul',$consul),"style='width:100px;'")."</th>\n";
	echo "<th><input class='case' name='closuree' value='' type='checkbox'></th>\n";
		echo "<th><input class='case' name='closuree' value='' type='checkbox'></th>\n";
		echo "<th></th>\n";
		echo "<th></th>\n";
		echo "<th></th>\n";
		...
		echo "<th></th>\n";
		echo "<th></th>\n";
		$array = array('i'=>'','wip_urgent'=>'WIP Urgent','wip_active'=>'WIP Active','wip_hold'=>'WIP Hold','client_hold'=>'Client Hold','mirus_drop'=>'Mirus Drop','client_drop'=>'Client Drop','lost_compt'=>'Lost Competition','lost_int'=>'Lost Internal','closed'=>'Closed');
...
echo    "<td><div align='center'>".$row->count2."</div></td>";
 ...
 echo    "<td><div align='center'>$row->sum7</div></td>";  echo    "<td><div align='center'>$row->cvsenton</div></td>";
