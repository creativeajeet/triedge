...
<?php
 ...
 foreach ($onhold_databank as $row){
...
<p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds and Total records found :: <b><?php echo $onhold; ?></b></p>
