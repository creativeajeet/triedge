...
<?php echo form_open('pof/admin/appraisal'); ?>
<table width="100%">
  <tr>
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" name="cons_name" value="<?php echo $this->session->userdata('username'); ?>" /></td>
  </tr>
  <tr>
    <td height="20">Date of Joining </td>
    <td height="20" colspan="2"><input type="text" name="join_date" class="input-medium datepick" /></td>
  </tr>
  <tr>
    <td height="20">Performance Appraisal for the period </td>
    <td height="20" colspan="2"><input type="text" name="app_period" value="Jan - July 2012" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><input type="text" name="total_added" /></td>
  </tr>
  <tr>
    <td height="20">b- % not sent to worksheet </td>
    <td height="20" colspan="2"><input type="text" name="no_work" /></td>
  </tr>
  <tr>
    <td height="20">c- % cv not attached </td>
    <td height="20" colspan="2"><input type="text" name="no_cv" /></td>
  </tr>
  <tr>
    <td>ii) No. of unattached CVs on VRS </td>
    <td colspan="2"><input type="text" name="no_cv_vrs" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="client_mgmt" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">ii) <strong>Facilitating Joining</strong> - % of drop outs across stages</td>
    <td height="20" colspan="2"><textarea name="facilitating" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
    <td height="20" colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="time_taken" cols="40"></textarea></td>
  </tr>
  <tr>
    ...
    <td height="20" colspan="2"><input type="text" name="exec_speed" /></td>
  </tr>
  <tr>
    <td height="20"><strong>C</strong>. Average calling time per  day</td>
    <td height="20" colspan="2"><input type="text" name="avg_calling" /></td>
  </tr>
  <tr>
    <td height="20"><strong>D. </strong>Referencing and Mapping  capacity (how many give reference out of every 10 calls)</td>
    <td height="20" colspan="2"><textarea name="referencing" cols="40"></textarea></td>
  </tr>
  <tr>
    ...
    <td height="20" colspan="2"><input type="text" name="avg_day" /></td>
  </tr>
  <tr>
    <td height="20"><strong>F</strong>. Average No. of CVs sent per position allocated</td>
    <td height="20" colspan="2"><input type="text" name="avg_cv_sent" /></td>
  </tr>
  <tr>
    <td height="20"><strong>G.</strong> % of resumes rejected internally / client</td>
    <td height="20" colspan="2"><textarea name="resumes_reject" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
    <td height="20" colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="handle_pres" cols="40"></textarea></td>
  </tr>
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="scalability" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20"><strong>C. </strong>Ability to multi task</td>
    <td height="20" colspan="2"><textarea name="multi_task" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
    <td height="20" colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="commit_excel" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20"><strong>B.</strong> Total Holidays Taken  /Unscheduled Holidays&nbsp; /Shorts / Lates</td>
    <td height="20" colspan="2"><input type="text" name="total_holidays" /></td>
  </tr>
  <tr>
    <td height="20"><strong>C.</strong> Ability to work without supervision</td>
    <td height="20" colspan="2"><textarea name="without_supervision" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20"><strong>D.</strong> Ability to meet commitments on delivery</td>
    <td height="20" colspan="2"><textarea name="meet_commit" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
    <td height="20" colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="high_value" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20"><strong>B.</strong> Number of mid value  relationships (Rs. 20 Lacs to Rs. 50 Lacs)</td>
    <td height="20" colspan="2"><textarea name="mid_value" cols="40"></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="ref_support" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">ii) Business Development Opportunities Introduced </td>
    <td height="20" colspan="2"><textarea name="business_dev" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">iii) Others </td>
    <td height="20" colspan="2"><textarea name="others" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
    <td height="20" colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="feedback_cand" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">ii) Transaction Flow </td>
    <td height="20" colspan="2"><textarea name="trans_flow" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
    <td height="20" colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="rel_peers" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20"><strong>B</strong>. Knowledge sharing with  Peers</td>
    <td height="20" colspan="2"><textarea name="sharing_peers" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
    <td height="20" colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="take_initiative" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20"><strong>B.</strong> Self Initiated  Improvisation / Going over and above assigned task</td>
    <td height="20" colspan="2"><textarea name="self_initiative" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
    <td height="20" colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="manage_process" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
    <td height="20" colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><input type="text" name="total_team_closure" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><textarea name="new_team" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20">ii) Retain team members </td>
    <td height="20" colspan="2"><textarea name="retain_team" cols="40"></textarea></td>
  </tr>
  <tr>
    <td height="20"><strong>C.</strong> &nbsp;&nbsp;Leadership  skills &ndash; state instances which exhibit the above trait</td>
    <td height="20" colspan="2"><textarea name="leadership" cols="40"></textarea></td>
  </tr>
  <tr>
