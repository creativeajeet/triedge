...
<table width="100%">
  ...
  <tr>
    ...
    <td width="7%"><div align="center"><?php print anchor('pof/admin/admin','All',array('class'=>'icon_pos','id'=>'current'))?></div>   </td>
    <td width="9%"><div align="center"><?php print anchor('pof/admin/allocated','Allocated',array('class'=>'icon_pos'))?></div>    </td>
...
<?php
 ...
 echo form_open('pof/admin/filterpos/');
	...
	echo "<th></th>\n";
    echo "<th></th>\n";
		echo "<th><input type='text' name='jobtitle' style='width:90px;'/></th>\n";
		echo "<th>".form_dropdown('company',array(''=>'')+$companyF,'',"style='width:100px;'")."</th>\n";
		echo "<th></th>\n";
		echo "<th>".form_dropdown('location',array(''=>'')+$locationF,'',"style='width:60px;'")."</th>\n";
		echo "<th><input type='text' name='grade' style='width:50px;'/></th>\n";
		echo "<th><input type='text' name='salary' style='width:50px;'/></th>\n";
 ...
 echo    "<th>".form_dropdown('posstatus',$array,'',"style='width:110px;'")."</th>";
		echo "<th></th>\n";
		echo "<th>".form_dropdown('consul',array(''=>'')+$consulF,'',"style='width:80px;'")."</th>\n";
		echo "<th></th>\n";
		echo "<th></th>\n";
...
if(($row->talked_on)==date('Y-m-d'))
 ...
 $array = array(''=>'','wip_urgent'=>'WIP Urgent','wip_active'=>'WIP Active','wip_hold'=>'WIP Hold','client_hold'=>'Client Hold','mirus_drop'=>'Mirus Drop','client_drop'=>'Client Drop','lost_compt'=>'Lost Competition','lost_int'=>'Lost Internal','closed'=>'Closed');
 echo    "<td>".form_hidden("pof_id[]",$row->pof_id).form_dropdown('pos_status[]',$array, set_value('pos_status',$row->pos_status),"style='width:110px;'")."</td>";
