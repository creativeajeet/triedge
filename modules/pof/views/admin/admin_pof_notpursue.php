...
<table width="100%">
  ...
  <tr>
    ...
    <td width="9%"><div align="center"><?php print anchor('pof/admin/not_pursuing','Not Pursuing',array('class'=>'icon_pos','id'=>'current'))?></div></td>
  </tr>
</table>
<?php echo form_close(); ?>

<?php echo form_open('pof/admin/columnSortAllocated'); ?>
<table width="100%">
  <tr>
