...
<?php
 ...
 foreach ($refpool_databank as $row){
...
$atts = array(
 ...
 <h2></h2>
<p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds and Total records found :: <b><?php echo $refpool; ?></b></p>
