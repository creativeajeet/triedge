...
echo "<tr valign='top'>\n";
 ...
 ?></td>
	...
	<br/>
	<h2>Candidates Rejected By Client </h2>
	<div id="show">
	<?php 
...
<?php
 if (count($clientrejected_databank)){ 
  echo "<table class='data'>\n";
	echo "<thead>\n";
	echo "<tr>\n";
	echo "<th></th>\n";
 ...
 foreach ($clientrejected_databank as $row){
...
$atts = array(
 ...
 <h2></h2>
<p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds and Total records found :: <b><?php echo $rejected; ?></b></p>
