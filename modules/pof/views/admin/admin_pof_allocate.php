...
echo "<tr valign='top'>\n";
 ...
 ?>
 <h2>Allocate to</h2>
<?php echo form_open('pof/admin/allocation/'.$pid.'/');?>
<table width="2371">
    <input name="jobtitle" type="hidden" value="<?php echo $row->comp.' - '.$row->jobtitle; ?>"/>
    <tr>
      <td height="19" colspan="8"><div align="right"><?php print anchor_popup('pof/admin/was','Work Allocation Viewer',array('class'=>'icon_alloc'))?></div></td>
    </tr>
    <tr>
      <td colspan="8"><table width="72%" id="table2"> 
   ...
   <tr bgcolor="#000033">
    ...
    <td width="68"><div align="center"><img src="<?php echo base_url()?>assets/icons/add.png" class="cloneTableRows"></div></td>
   </tr>
   <tr height="10"></tr>
   <tr height="20">
	...
	<tr>
	  ...
	  <td><div align="left">Target Resumes </div></td>
	  <td colspan="3"><select name="target_resume" style="width:100px; background-color:#CCCCCC">
	     <option value=""></option>
	    <option>1</option>
	    <option>2</option>
	    <option>3</option>
	...
	<tr>
      <td width="157" height="19"><div align="left">Allocation date </div></td>
      <td width="158" height="19"><input name="fad" class="datepicker" type="text" size="10" style="background:#CCCCCC" value="<?php echo date('Y-m-d'); ?>"/></td>
      <td width="174"><div align="left">Allocated By </div></td>
      <td width="146"><input name="allocated_by" type="text" size="10" style="background:#CCCCCC" value="<?php echo $this->session->userdata('username'); ?>"/></td>
      <td width="196">&nbsp;</td>
      <td colspan="3">Instruction</td>
	</tr>
	<tr>
      <td width="157" height="19"><div align="left">Supervise By </div></td>
      <td width="158" height="19"><?php echo form_dropdown("superviser",array('0'=>'')+$consultant,"","id='id', style='width:143px; background-color:#CCCCCC'");?></td>
      <td width="174">&nbsp;</td>
      <td width="146">&nbsp;</td>
      <td width="196">&nbsp;</td>
      <td height="19" colspan="3"><textarea name="instruction" cols="20" style="background:#CCCCCC"/></textarea></td>
	</tr>
	<tr>
      <td colspan="5"><div align="right">
        <input name="not_pursuing" type="submit" class="btn btn-primary" value="Not Pursuing" />
            </div></td>
      <td width="75"><div align="left">P. Focus </div></td>
	  <td width="67"><input id='pofid' name='pofid[]' type='checkbox' /></td>
	  <td width="100"><div align="right">
        <input name="submit" type="submit" class="btn btn-primary" value="Allocate" />
      </div></td>
	</tr>
</table>
</body>
