...
<table width="1018" align="center">
  ...
  <tr class="style2">
    ...
    <input name="from" type="text" size="15" class="input-medium datepick" value="<?php echo $from; ?>"> </td>
    <td width="53"><div align="center">To</div></td>
    <td width="109"><input name="to" type="text" size="15" class="input-medium datepick" value="<?php echo $to; ?>"></td>
    <td width="100"><div align="center">Consultant</div></td>
    <td colspan="2"><?php echo form_dropdown('consultant', array('0'=>'All')+$consultant,set_value('stage',$consul),'style="width:120px;"'); ?></td>
    <td width="75"><div align="center">Client</div></td>
    <td width="144"><?php echo form_dropdown('client', array('0'=>'All')+$clients,set_value('stage',$client),'style="width:120px;"'); ?></td>
    <td width="111">
...
<div align="right"><div style="margin-bottom:-20px; margin-right:320px"><div style="margin-right:20px">CVs Actual Date Shared Not Marked::</div><div style="color:#FF0000; margin-left:18px; margin-top:-18px; font-size:14px"><b><?php echo $nomark; ?></b></div></div><div style="margin-right:150px"><div style="margin-right:20px">CVs not attached::</div><div style="color:#FF0000; margin-left:18px; margin-top:-18px; font-size:14px"><b><?php echo $nocv; ?></b></div></div><div style="margin-top:-18px; margin-right:20px">Total CVs sent::</div><div style="color:#FF0000; margin-top:-18px; font-size:14px"><b><?php echo $total; ?></b></div></div>
<div id="show">
<?php
 if (count($results)){ 
 echo "<table id='data'>\n";
