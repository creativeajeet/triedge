$(document).ready(function(){
    ...
    $('#start,#end,#date_completed,#dor, #sssdate1,#sssdate2,#sssdate3,#sssdate4,#sssdate5,#sssdate6,#sssdate7,#sssdate8,#sssdate9,#sssdate10, #sssdate, #redate,#mapdate,#spdate,#tfrdate, #tlrdate').datepick({dateFormat: 'dd-mm-yy'});
